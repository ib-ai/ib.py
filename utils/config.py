...
description = (
    os.getenv("DESCRIPTION") if "DESCRIPTION" in os.environ else _config["description"]
)
application_id = (
    os.getenv("APPLICATION_ID")
    if "APPLICATION_ID" in os.environ
    else _config["application_id"]
)
...
db_password = (
    os.getenv("DB_PASSWORD") if "DB_PASSWORD" in os.environ else _config["db_password"]
)
